...
class C0092X {
    ...
    /* renamed from: a */
    static Notification m363a(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z) {
        boolean z2;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        return deleteIntent.setFullScreenIntent(pendingIntent2, z5).setLargeIcon(bitmap).setNumber(i).setProgress(i2, i3, z).getNotification();
    }
}
