...
/* renamed from: com.cootek.smartinput5.ui.schema.template.T_kr_soft_phonepad_chunjiin */
public class T_kr_soft_phonepad_chunjiin extends KeyboardSchema {
    public T_kr_soft_phonepad_chunjiin() {
        ...
        bVar8.mainTextSize = "@dimen/button_textsize";
        bVar8.keyWidth = "15%p";
        bVar8.keyType = "Key";
        ...
        bVar9.mainTitleRef = "ㅂㅍ";
        bVar9.horizontalGap = "15%p";
        bVar9.keyType = "Key";
        C2944b bVar10 = new C2944b();
        bVar10.keyName = "sk_3_2";
        bVar10.mainTitleRef = "ㅂㅍ";
        bVar10.keyType = "Key";
        C2944b bVar11 = new C2944b();
        bVar11.keyName = "sk_3_3";
        bVar11.mainTitleRef = "ㅂㅍ";
        bVar11.keyType = "Key";
        C2944b bVar12 = new C2944b();
        bVar12.keyX = "85%p";
        bVar12.keyName = "sk_emoji";
        bVar12.backgroundType = "fun";
        bVar12.hasLongPressIcon = "false";
        bVar12.keyIcon = "drawable/key_fore_sym_emo";
        bVar12.iconPreview = "drawable/key_fore_sym_emo";
        ...
        bVar13.hasLongPressIcon = "true";
        bVar13.iconPreview = "drawable/key_preview_sym";
        ...
        bVar14.keyIcon = "drawable/key_fore_setting";
        bVar14.mainOnlyTextSize = "dimen/button_textsize";
        bVar14.keyWidth = "11.65%p";
        bVar14.keyType = "LanguageKey";
        C2944b bVar15 = new C2944b();
        bVar15.keyName = "Dot";
        bVar15.supportPreviewPopup = "false";
        bVar15.keyWidth = "11.65%p";
        bVar15.keyType = "Key";
        C2944b bVar16 = new C2944b();
        bVar16.keyName = "sk_4_1";
        bVar16.mainTitleRef = "ㅂㅍ";
        bVar16.keyWidth = "23.3%p";
        bVar16.keyType = "Key";
        C2944b bVar17 = new C2944b();
        bVar17.keyName = "sk_sp";
        bVar17.binType = "dict";
        bVar17.foregroundType = "fitCenter";
        bVar17.ignoreCurve = "true";
        bVar17.ignoreStroke = "true";
        bVar17.keyIcon = "@drawable/key_sp_normal";
        bVar17.iconPreview = "@drawable/key_preview_space";
        bVar17.keyWidth = "23.3%p";
        bVar17.altTextInCorner = "true";
        bVar17.keyType = "SpaceKey";
