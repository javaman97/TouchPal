...
/* renamed from: com.cootek.smartinput5.ui.schema.template.T_chs_sym_grid */
public class T_chs_sym_grid extends KeyboardSchema {
    public T_chs_sym_grid() {
        ...
        bVar.keyName = "sk_lock";
        bVar.backgroundType = "fun";
        bVar.triType = "lock";
        bVar.ignoreSlip = "true";
        bVar.keyIcon = "@drawable/key_fore_lock_status";
        bVar.keyEdgeFlags = Settings.KEYBOARD_MARGIN_LEFT;
        bVar.keyWidth = "@fraction/bottom_key_width_1";
        bVar.keyType = "Key";
        C2944b bVar2 = new C2944b();
        bVar2.keyName = "sk_back";
        bVar2.backgroundType = "fun_highlight";
        bVar2.ignoreSlip = "true";
        bVar2.keyIcon = "@drawable/key_fore_back";
        bVar2.keyWidth = "17%p";
        bVar2.keyType = "Key";
