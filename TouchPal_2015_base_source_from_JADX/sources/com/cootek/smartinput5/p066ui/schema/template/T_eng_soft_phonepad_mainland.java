...
/* renamed from: com.cootek.smartinput5.ui.schema.template.T_eng_soft_phonepad_mainland */
public class T_eng_soft_phonepad_mainland extends KeyboardSchema {
    public T_eng_soft_phonepad_mainland() {
        ...
        bVar16.keyWidth = "@fraction/bottom_key_width_4";
        ...
        bVar18.keyName = "sk_dict";
        bVar18.backgroundType = "fun";
        bVar18.binType = "dict";
        bVar18.ignoreCurve = "true";
        bVar18.keyIcon = "@drawable/key_fore_dict";
        bVar18.keyWidth = "@fraction/bottom_key_width_1";
        bVar18.keyType = "Key";
        C2944b bVar19 = new C2944b();
        bVar19.keyX = "@fraction/bottom_key_width_2_minus";
        bVar19.keyName = "sk_ent";
        bVar19.backgroundType = "fun";
        bVar19.ignoreCurve = "true";
        bVar19.keyIcon = "@drawable/key_fore_enter";
        bVar19.keyEdgeFlags = Settings.KEYBOARD_MARGIN_RIGHT;
        bVar19.mainOnlyTextSize = "@dimen/button_textsize";
        bVar19.keyWidth = "@fraction/bottom_key_width_2";
        bVar19.keyType = EnterKey.TAG;
        rowSchema4.keys = new C2944b[]{bVar13, bVar14, bVar15, bVar16, bVar17, bVar18, bVar19};
