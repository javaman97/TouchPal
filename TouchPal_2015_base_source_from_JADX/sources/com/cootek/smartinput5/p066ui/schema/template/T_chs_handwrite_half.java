...
/* renamed from: com.cootek.smartinput5.ui.schema.template.T_chs_handwrite_half */
public class T_chs_handwrite_half extends KeyboardSchema {
    public T_chs_handwrite_half() {
        this.height = "fraction/hwhalf_keyboard_height";
        this.slipThreshold = "60%p";
        this.shadowRect = "0%p:0%p:100%p:82.5%p,10%p:82.5%p:100%p:100%p";
        ...
        bVar9.keyWidth = "@fraction/bottom_key_width_space_shrink";
