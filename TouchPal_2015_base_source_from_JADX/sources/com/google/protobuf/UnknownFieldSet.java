...
public final class UnknownFieldSet implements MessageLite {
    ...
    public int getSerializedSize() {
        ...
        while (true) {
            ...
            i = ((Field) next.getValue()).getSerializedSize(((Integer) next.getKey()).intValue()) + i2;
        }
    }
    ...
    public int getSerializedSizeAsMessageSet() {
        ...
        while (true) {
            ...
            Map.Entry next = it.next();
            i = ((Field) next.getValue()).getSerializedSizeAsMessageSetExtension(((Integer) next.getKey()).intValue()) + i2;
        }
    }
    ...
    public static final class Field {
        ...
        public int getSerializedSizeAsMessageSetExtension(int i) {
            ...
            while (true) {
                ...
                i2 = CodedOutputStream.computeRawMessageSetExtensionSize(i, it.next()) + i3;
            }
        }
