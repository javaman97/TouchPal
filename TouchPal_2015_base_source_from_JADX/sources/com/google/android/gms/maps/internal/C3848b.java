...
public interface C3848b extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.b$a */
    public static abstract class C3849a extends Binder implements C3848b {

        /* renamed from: com.google.android.gms.maps.internal.b$a$a */
        private static class C3850a implements C3848b {

            /* renamed from: a */
            private IBinder f16007a;

            C3850a(IBinder iBinder) {
                this.f16007a = iBinder;
            }
            ...
            public void onCancel() throws RemoteException {
                ...
                try {
                    ...
                    this.f16007a.transact(2, obtain, obtain2, 0);
            ...
            public void onFinish() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICancelableCallback");
                    this.f16007a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: u */
        public static C3848b m16762u(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C3848b)) ? new C3850a(iBinder) : (C3848b) queryLocalInterface;
        }
