...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class C3841a extends Binder implements IMapViewDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapViewDelegate$a$a */
        private static class C3842a implements IMapViewDelegate {

            /* renamed from: a */
            private IBinder f16004a;

            C3842a(IBinder iBinder) {
                this.f16004a = iBinder;
            }
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    this.f16004a.transact(1, obtain, obtain2, 0);
            ...
            public C3549b getView() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f16004a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void onCreate(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f16004a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f16004a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onLowMemory() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f16004a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onPause() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f16004a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onResume() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f16004a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onSaveInstanceState(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f16004a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        /* renamed from: A */
        public static IMapViewDelegate m16757A(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IMapViewDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C3842a(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int r4, android.os.Parcel r5, android.os.Parcel r6, int r7) throws android.os.RemoteException {
            ...
            L_0x00b2:
                ...
                goto L_0x0009
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.maps.internal.IMapViewDelegate.C3841a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }

    IGoogleMapDelegate getMap() throws RemoteException;

    C3549b getView() throws RemoteException;
