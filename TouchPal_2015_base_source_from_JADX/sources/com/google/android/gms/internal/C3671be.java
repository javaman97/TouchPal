...
public interface C3671be extends IInterface {

    /* renamed from: com.google.android.gms.internal.be$a */
    public static abstract class C3672a extends Binder implements C3671be {

        /* renamed from: com.google.android.gms.internal.be$a$a */
        private static class C3673a implements C3671be {

            /* renamed from: a */
            private IBinder f15571a;

            C3673a(IBinder iBinder) {
                this.f15571a = iBinder;
            }
            ...
            public void onAddGeofencesResult(int i, String[] strArr) throws RemoteException {
                ...
                try {
                    ...
                    this.f15571a.transact(1, obtain, obtain2, 0);
            ...
            public void onRemoveGeofencesByPendingIntentResult(int i, PendingIntent pendingIntent) throws RemoteException {
                ...
                try {
                    ...
                    this.f15571a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onRemoveGeofencesByRequestIdsResult(int i, String[] strArr) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeStringArray(strArr);
                    this.f15571a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: q */
        public static C3671be m16097q(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C3671be)) ? new C3673a(iBinder) : (C3671be) queryLocalInterface;
        }
