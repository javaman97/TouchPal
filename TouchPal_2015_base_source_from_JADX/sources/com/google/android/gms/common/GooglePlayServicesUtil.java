...
import com.google.android.gms.internal.C3776i;
import com.google.android.gms.internal.C3788m;
...
public final class GooglePlayServicesUtil {
    ...
    /* renamed from: a */
    public static Intent m15333a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return m15339b(i2) ? m15342c(context) ? C3788m.m16629l(GOOGLE_PLAY_SERVICES_PACKAGE) : C3788m.m16628k("com.google.android.apps.bazaar") : C3788m.m16628k(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return C3788m.m16626i(GOOGLE_PLAY_SERVICES_PACKAGE);
            default:
                return null;
        }
    }
    ...
    /* renamed from: a */
    public static String m15334a(Context context, int i) {
    ...
    /* renamed from: a */
    public static boolean m15335a(Resources resources) {
        return (C3608as.m15697an() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m15340b(resources);
    }

    /* renamed from: a */
    private static byte[] m15336a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[][] m15337a(byte[][]... bArr) {
        int i = 0;
    ...
    /* renamed from: b */
    public static String m15338b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                String string = m15335a(context.getResources()) ? resources.getString(R.string.common_google_play_services_install_text_tablet) : resources.getString(R.string.common_google_play_services_install_text_phone);
                return m15339b(i2) ? string + " (via Bazaar)" : string;
            case 2:
                String string2 = resources.getString(R.string.common_google_play_services_update_text);
                return m15339b(i2) ? string2 + " (via Bazaar)" : string2;
            case 3:
    ...
    /* renamed from: b */
    private static boolean m15340b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return C3608as.m15699ap() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    /* renamed from: c */
    private static int m15341c(int i) {
        if (i == -1) {
            return 2;
        }
        return i;
    ...
    /* renamed from: c */
    private static boolean m15342c(Context context) {
        if (f15244J) {
            return f15246L;
        }
        try {
            return m15336a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f15243I) != null;
    ...
    /* renamed from: c */
    private static byte[] m15343c(String str) {
        try {
    ...
    /* renamed from: g */
    public static boolean m15344g() {
        return f15244J ? f15245K : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int i, Activity activity, int i2) {
        return m15332a(i, activity, i2, (DialogInterface.OnCancelListener) null, -1);
    }

    public static Dialog getErrorDialog(int i, Activity activity, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return m15332a(i, activity, i2, onCancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        Intent a = m15333a(context, i, -1);
        if (a == null) {
            return null;
        }
        return PendingIntent.getActivity(context, i2, a, Engine.EXCEPTION_ERROR);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            byte[] a = m15336a(packageManager.getPackageInfo("com.android.vending", 64), f15237C);
            if (a == null) {
