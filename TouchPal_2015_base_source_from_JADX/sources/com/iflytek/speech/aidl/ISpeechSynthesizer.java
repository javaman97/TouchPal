        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    int synthesizeToUrl = synthesizeToUrl(intent, SynthesizerListener.Stub.asInterface(parcel.readStrongBinder()));
                ...
                case 2:
                    ...
                    int startSpeaking = startSpeaking(intent, SynthesizerListener.Stub.asInterface(parcel.readStrongBinder()));
                    parcel2.writeNoException();
